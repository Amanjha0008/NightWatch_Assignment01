...
class AllureReporter {
    ...
    startCase(test) {
        ...
        this.currentTest.addLabel(allure_js_commons_1.LabelName.TAG, "" + currentDate);
        if (test.reportPrefix) {
            this.currentTest.addLabel(allure_js_commons_1.LabelName.TAG, test.reportPrefix);
    ...
    partialTestCase(test) {
        this.startCase(test);
        this.endTest(allure_js_commons_1.Status.BROKEN, { message: "Test ignored" });
    }
